module.exports = {
    ...
    currentDB: "remote",
    mysql: {
        host: process.env.MYSQL_HOST || 'mysql-angelojz7.alwaysdata.net',
        user: process.env.MYSQL_USER || 'angelojz7_micros',
        password: process.env.MYSQL_PASS || 'milewid',
        database: process.env.MYSQL_DB || 'angelojz7_reciclick',
